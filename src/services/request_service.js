...
exports.send_request = async (req, res) => {
    try {
        ...
        const existingRequest = receiverData.requests.find(request => request.sender_id.equals(senderID));
...
exports.acceptRequest = async(req,res)=>{
    try {
        ...
        if(userDatasave,savedata){
            ...
            let requested_data = user.requests.findIndex((request)=>request._id == _id);
